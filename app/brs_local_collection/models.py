...
class BankReconLocalCollectionSummary(db.Model):
    ...
    local_collection_bank_branch_name: Mapped[str]
    local_collection_bank_branch_location: Mapped[str]
    local_collection_bank_account_type: Mapped[str]
    local_collection_bank_account_number: Mapped[str]
    local_collection_bank_ifsc_code: Mapped[str]
...
class BankReconLocalCollectionDelete(db.Model):
    id: Mapped[IntPK]

    month: Mapped[str]
    enable_delete: Mapped[bool] = mapped_column(default=False)
