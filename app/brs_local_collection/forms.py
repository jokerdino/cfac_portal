...
class AddBankReconLocalCollectionSummaryForm(FlaskForm):
    regional_office = IntegerField(validators=[NumberRange(min=10000, max=500800)])
    operating_office = IntegerField(validators=[NumberRange(min=10000, max=500800)])
    month = StringField()
    purpose_of_bank_account = SelectField(choices=["Local collection", "PMSBY"])
    local_collection_bank_name = StringField()
    local_collection_bank_branch_name = StringField()
    local_collection_bank_branch_location = StringField()
    local_collection_bank_account_type = StringField()
    local_collection_bank_account_number = StringField()
    local_collection_bank_ifsc_code = StringField()
