...
class BankReconEntryForm(FlaskForm):
    ...
    file_bank_statement = FileField("Upload bank statement", validators=[Optional()])
...
class AddBankReconTieupSummaryForm(FlaskForm):
    ...
    gl_identifier = StringField(validators=[DataRequired()])
    tieup_partner_name = StringField(validators=[DataRequired()])
    tieup_bank_name = StringField(validators=[DataRequired()])
    tieup_bank_account_number = StringField(validators=[DataRequired()])
    tieup_bank_ifsc_code = StringField(validators=[DataRequired()])
    tieup_gc_gl_code = StringField(validators=[DataRequired()])
    tieup_gc_bank_code = StringField(validators=[DataRequired()])
    tieup_gc_branch_code = StringField(validators=[DataRequired()])
    tieup_gc_bank_name = StringField(validators=[DataRequired()])
    tieup_bank_branch_name = StringField(validators=[DataRequired()])
    tieup_bank_branch_address = StringField(validators=[DataRequired()])
