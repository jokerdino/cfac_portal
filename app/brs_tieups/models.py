...
class BankReconTieupSummary(db.Model):
    ...
    tieup_gc_gl_code: Mapped[str]
    tieup_gc_bank_code: Mapped[str]
    tieup_gc_branch_code: Mapped[str]
    tieup_gc_bank_name: Mapped[str]

    tieup_bank_branch_name: Mapped[Optional[str]]
    tieup_bank_branch_address: Mapped[Optional[str]]
